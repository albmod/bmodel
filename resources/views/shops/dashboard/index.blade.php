                    ...
                    <div class="col-lg-6 col-md-4">
                        <div class="inner">
                            <div class="bradcrumb-thumb">
                                <img src="{{asset('assets/shop/images/product/product-45.png')}}" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="axil-dashboard-warp">
                    <div class="axil-dashboard-author">
                        <div class="media">
                            <div class="thumbnail">
                                <img src="{{asset('assets/shop/images/product/author1.png')}}" alt="Hello  {{auth('customer') -> user() -> name}}">
                            </div>
                            <div class="media-body">
                                <h5 class="title mb-0">Hello  {{auth('customer') -> user() -> name}}</h5>
                                <span class="joining-date">BModel Member Since Sep 2020</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <aside class="axil-dashboard-aside">
                                <nav class="axil-dashboard-nav">
                                    <div class="nav nav-tabs" role="tablist">
                                        ...
                                        <a class="nav-item nav-link" href="{{route('logout-customer')}}"><i class="fal fa-sign-out"></i>Logout</a>
                                    </div>
                                </nav>
                            </aside>
                        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="nav-dashboard" role="tabpanel">
                                    <div class="axil-dashboard-overview">
                                        <div class="welcome-text"> {{auth('customer') -> user() -> name}}</div>
