                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="text-muted fw-bolder">
                                ...
                                <a href="#">{{trans('seller.menu.settings_list.shipping_list.internal_shipping')}}</a>
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold flex-nowrap">
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <b> <a class="nav-link text-active-primary me-6 active" href="{{route('settings.shipping','inner')}}">{{trans('seller.menu.settings_list.shipping_list.internal_shipping')}} </a></b>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
                        ...
                        <div class="card mb-5 mb-xl-10">
                            ...
                            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_signin_method">
                                <div class="card-title m-0">
                                    <h3 class="fw-bolder m-0">{{trans('seller.menu.settings_list.shipping_list.internal_shipping')}}  </h3>
                                </div>
                            </div>
                            <!--end::Card header-->
                            <!--begin::Content-->
