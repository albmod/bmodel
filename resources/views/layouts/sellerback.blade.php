...
<head><base href="">
    ...
    <meta name="keywords" content="vsuite," />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Vsuite" />
    <meta property="og:url" content="" />
    <meta property="og:site_name" content="Vsuite" />
    <link rel="canonical" href="" />
    <link rel="shortcut icon" href="{{asset('assets/favicon.png')}}" />
    <!--begin::Fonts-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Cairo&family=Roboto:300,400,500,600,700" />
    <!--end::Fonts-->
    <!--begin::Page Vendor Stylesheets(used by this page)-->
    <link href="{{asset('assets/sellerback/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />
    <!--end::Page Vendor Stylesheets-->
    <!--begin::Global Stylesheets Bundle(used by all pages)-->
    <link href="{{asset('assets/sellerback/plugins/global/plugins.bundle.css')}}" rel="stylesheet" type="text/css" />


    @if(App::isLocale('ar'))
        <link href="{{asset('assets/sellerback/css/style.bundle.rtl.css')}}" rel="stylesheet" type="text/css" />
        <style>
    ...
    @else
        <link href="{{asset('assets/sellerback/css/style.bundle.css')}}" rel="stylesheet" type="text/css" />
@endif
    <!--end::Global Stylesheets Bundle-->
    <style>
        .card {
            border: 0;
            -moz-box-shadow: 0 4px 4px #cdced4;
            -webkit-box-shadow: 0 4px 4px #cdced4;
            box-shadow: 0 4px 4px rgba(0, 0, 0, 0.2);
            /*box-shadow: 0px 0px 9px 0px #cdced4;*/
        }
    </style>
    @stack('styles')
</head>
<!--end::Head-->
<!--begin::Body-->
<body id="kt_body" style="background-image: url({{asset('assets/sellerback/media/patterns/header-bg.jpg')}})" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
<!--begin::Main-->
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div id="kt_header" class="header align-items-stretch" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                ...
                <div class="container-xxl d-flex align-items-center">
                    ...
                    <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
                        <a href="{{route('site')}}">
                            <img alt="Logo" src="{{asset('assets/sellerback/media/logos/logo.png')}}" class="logo-default h-30px" />
                            <img alt="Logo" src="{{asset('assets/sellerback/media/logos/logo-sticky.png')}}" class="logo-sticky h-30px" />
                        </a>
                    </div>
                    <!--end::Header Logo-->
                    <!--begin::Wrapper-->
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                        <!--begin::Navbar-->
                        @include('sellers.includes.back.menu')
                        <!--end::Navbar-->
                        <!--begin::Topbar-->
                        @include('sellers.includes.back.topbar')
                        <!--end::Topbar-->
                    </div>
                    <!--end::Wrapper-->
                </div>
            ...
            <!--end::Header-->
            <!--begin::Toolbar-->
        @include('sellers.includes.back.toolbar')
            <!--end::Toolbar-->
            <!--begin::Container-->
        @yield('content')
            <!--end::Container-->
            <!--begin::Footer-->
        @include('sellers.includes.back.footer')
            <!--end::Footer-->
        </div>
        <!--end::Wrapper-->
    </div>
...
@include('sellers.includes.back.drawer.activities_drawer')
<!--end::Activities drawer-->
<!--begin::Chat drawer-->
@include('sellers.includes.back.drawer.chat_drawer')
<!--end::Chat drawer-->

<!--begin::Drawers-->
{{--@include('sellers.includes.back.drawer.explore_drawer')--}}
<!--end::Drawers-->
...
<script>var hostUrl = "assets/sellerback";</script>
<!--begin::Javascript-->
<!--begin::Global Javascript Bundle(used by all pages)-->
<script src="{{asset('assets/sellerback/plugins/global/plugins.bundle.js')}}"></script>
<script src="{{asset('assets/sellerback/js/scripts.bundle.js')}}"></script>
<!--end::Global Javascript Bundle-->
<!--begin::Page Vendors Javascript(used by this page)-->
<script src="{{asset('assets/sellerback/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"></script>
<!--end::Page Vendors Javascript-->
<!--begin::Page Custom Javascript(used by this page)-->
<script src="{{asset('assets/sellerback/js/custom/widgets.js')}}"></script>
<script src="{{asset('assets/sellerback/js/custom/apps/chat/chat.js')}}"></script>
<script src="{{asset('assets/sellerback/js/custom/modals/create-app.js')}}"></script>
<script src="{{asset('assets/sellerback/js/custom/modals/upgrade-plan.js')}}"></script>
